...
export function useGoals(householdId: MaybeRefOrGetter<string | null>) {
  return useQuery({
    queryKey: ['households', () => toValue(householdId), 'goals'],
    queryFn: () => goalsApi.list(toValue(householdId) as string),
